...
const translations = {
  ...
  'settings.apiKey.desc': { en: 'Stored locally in your browser. Required to run scenarios and generate the regulations knowledge base.', he: 'נשמר מקומית בדפדפן. נדרש להרצת תרחישים ויצירת מאגר הידע של רגולציה.' },
  // ── DriverU ──
  ...
  'builder.apiKeyRequired': { en: 'API key required — set it in Settings', he: 'נדרש מפתח API — הגדר בהגדרות' },
  ...
  // ── Regulations Management Tab ──
  'header.regulations': { en: 'Regulations', he: 'רגולציה' },
  'regMgmt.title': { en: 'Regulations Management', he: 'ניהול רגולציה' },
  'regMgmt.subtitle': { en: 'Upload regulation documents and build the knowledge base used by all scenarios.', he: 'העלה מסמכי רגולציה ובנה את מאגר הידע המשמש בכל התרחישים.' },
  'regMgmt.sources.title': { en: 'Source Files', he: 'קבצי מקור' },
  'regMgmt.sources.empty': { en: 'No regulation files uploaded yet.', he: 'לא הועלו קבצי רגולציה עדיין.' },
  'regMgmt.sources.upload': { en: 'Upload file', he: 'העלה קובץ' },
  'regMgmt.sources.dropHint': { en: 'TXT · MD · PDF · DOCX · max {kb}KB per file', he: 'TXT · MD · PDF · DOCX · עד {kb}KB לקובץ' },
  'regMgmt.sources.status.raw': { en: 'Pending extraction', he: 'ממתין לחילוץ' },
  'regMgmt.sources.status.processed': { en: 'Processed', he: 'עובד' },
  'regMgmt.sources.entries': { en: '{n} entries', he: '{n} רשומות' },
  'regMgmt.sources.uploadedAt': { en: 'Uploaded {when}', he: 'הועלה {when}' },
  'regMgmt.sources.viewExtracted': { en: 'View extracted entries', he: 'הצג רשומות שחולצו' },
  'regMgmt.sources.hideExtracted': { en: 'Hide extracted entries', he: 'הסתר רשומות שחולצו' },
  'regMgmt.kb.title': { en: 'Knowledge Base', he: 'מאגר הידע' },
  'regMgmt.kb.empty': { en: 'The knowledge base is empty. Upload files and click Generate, or add entries manually.', he: 'מאגר הידע ריק. העלה קבצים ולחץ על צור, או הוסף רשומות ידנית.' },
  'regMgmt.kb.generate': { en: 'Generate Knowledge Base', he: 'צור מאגר ידע' },
  'regMgmt.kb.generating': { en: 'Generating...', he: 'יוצר...' },
  'regMgmt.kb.regenerateHint': { en: 'Re-extracts entries from all files. Manual entries are preserved.', he: 'חולץ מחדש רשומות מכל הקבצים. רשומות ידניות נשמרות.' },
  'regMgmt.kb.fromFile': { en: 'From {file}', he: 'מהקובץ {file}' },
  'regMgmt.kb.manual': { en: 'Manual', he: 'ידני' },
  'regMgmt.kb.addManual': { en: 'Add manual entry', he: 'הוסף רשומה ידנית' },
  'regMgmt.kb.totalEntries': { en: '{n} entries total', he: 'סה"כ {n} רשומות' },
  'regMgmt.errors.tooLarge': { en: 'File exceeds {kb}KB limit.', he: 'הקובץ חורג ממגבלת {kb}KB.' },
  'regMgmt.errors.unsupported': { en: 'Unsupported file type. Use TXT, MD, PDF, or DOCX.', he: 'סוג קובץ לא נתמך. השתמש ב-TXT, MD, PDF או DOCX.' },
  'regMgmt.errors.parse': { en: 'Could not read {file}.', he: 'לא ניתן לקרוא את {file}.' },
  'regMgmt.errors.apiKey': { en: 'A Claude API key is required — set it in Settings.', he: 'נדרש מפתח Claude API — הגדר בהגדרות.' },
  'regMgmt.errors.extract': { en: 'Extraction failed for {file}: {error}', he: 'חילוץ נכשל עבור {file}: {error}' },
  'regMgmt.confirm.deleteFile': { en: 'Delete this file and its extracted entries?', he: 'למחוק את הקובץ ואת הרשומות שחולצו ממנו?' },
