    ...
    <div className="flex gap-6 h-full">
      ...
      <div className="w-72 shrink-0 space-y-5">
        ...
        <div className="bg-bg-card rounded-xl border border-border p-4">
          <label className="block text-xs text-text-muted uppercase tracking-wider mb-2">{t('builder.fundType')}</label>
          <select
            value={fundType}
          ...
          {/* Use Case */}
          <label className="block text-xs text-text-muted uppercase tracking-wider mb-2 mt-4">{t('builder.action')}</label>
        ...
        {!memberData && (
          <p className="text-[10px] text-text-muted text-center -mt-3">{t('builder.generateFirst')}</p>
        )}
        {memberData && !apiKey && (
          <p className="text-[10px] text-warning text-center -mt-3">{t('builder.apiKeyRequired')}</p>
        )}

        {/* Bulk Launch */}
        <div className="bg-bg-card rounded-xl border border-border p-4">
          <h3 className="text-xs text-text-muted uppercase tracking-wider mb-2">{t('builder.bulk')}</h3>
          <p className="text-[11px] text-text-muted mb-3">{t('builder.bulk.desc')}</p>
          ...
          {floodCount >= 50 && (
            <p className="text-[10px] text-warning mb-2">{t('builder.bulk.warning')}</p>
          )}
